<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-0.9.8-0f9f7f?style=flat-square" alt="Version 0.9.8">
    ...
    <img src="https://img.shields.io/badge/tests-85%20passed-0f9f7f?style=flat-square" alt="85 tests passed">
  </p>
...
| 新会话与子代理 | Codex 可通过工作台入口显式创建新会话；原生子代理由 Codex 按任务自主委派，准确区分运行、完成与异常，新主轮不会错误复活历史代理，点击可在右侧查看完整子会话 |
